        ...
        <div class="row p-3 py-3">
            <div class="container card-collection-proj py-5">
                ...
                <div class="cardx">
                    ...
                    <div>
                        <h3 class="container handy text-uppercase"><a onclick="ViewCerti(this)" data-val="certi1.pdf">Title</a></h3>
                    </div>
                    <div class="container">
                ...
                <div class="cardx">
                    ...
                    <div>
                        <h3 class="container handy text-uppercase"><a onclick="ViewCerti(this)" data-val="certi2.pdf">Title</a></h3>
                    </div>
                    <div class="container">
                        <p>Lorem ipsum dolor sit amet consectetur</p>
                    </div>
                ...
                <div class="cardx">
                    ...
                    <div>
                        <h3 class="container handy text-uppercase"><a onclick="ViewCerti(this)" data-val="certi3.pdf">Title</a></h3>
                    </div>
                    <div class="container">
                        <p>Lorem ipsum dolor sit amet consectetur</p>
                    </div>
