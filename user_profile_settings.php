            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12 mt-3"><label class="labels">Present Address</label><input type="text" class="form-control" placeholder="enter present address" value=""></div>
                        <div class="col-md-12 mt-3"><label class="labels">Parmanent Address</label><input type="text" class="form-control" placeholder="enter permanent address" value=""></div>
                        <div class="col-md-12 mt-3"><label class="labels">Postcode</label><input type="text" class="form-control" placeholder="enter address line 2" value=""></div>
